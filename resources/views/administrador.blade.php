...
<head>
    ...
    <meta charset="utf-8" />
    <title>Placas Vehiculares</title>
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            <a href="{{ route('admin.vehiculo.index') }}">
                                <i class="bx bxs-edit icon nav-icon"></i>
                                <span class="menu-item" data-key="t-calendar">Registro</span>
                            </a>
                        </li>
                                ...
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="topnav-pages">
                                            ...
                                            <div class="dropdown">
                                                <a class="dropdown-item dropdown-toggle arrow-none" href="#"
                                                    id="topnav-invoice" role="button"><span
                                                        data-key="t-invoices">Invoices</span>
                                                    <div class="arrow-down"></div>
                                                </a>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="topnav-contact">
                                                    ...
                                                    <a href="contacts-profile.html" class="dropdown-item"
                                                        data-key="t-user-settings">Profile</a>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="topnav-more">
                                            ...
                                            <a href="layouts-vertical.html" class="dropdown-item"
