<div class="card rounded-3 w-md-500px">
    <div class="card-body d-flex flex-column p-10 p-lg-20 pb-lg-10">
        <div class="d-flex flex-center flex-column-fluid pb-5 pb-lg-15">
            <form class="form w-100" wire:submit.prevent="ingresar">
                ...
                <div class="fv-row mb-5">
                    ...
                    <input type="email" wire:model="email" class="form-control @error('email') is-invalid @enderror" id="email" placeholder="Ingrese su usuario" autocomplete="off"/>
                    @error('email')
                ...
                @endif
                <div class="mt-5">
                    <button type="submit" class="btn btn-primary w-100" wire:loading.attr="disabled" wire:target="ingresar">
